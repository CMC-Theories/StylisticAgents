...
public class BirdLogic_Old : MonoBehaviour
{
    ...
    public static List<BirdMovement_Old> otherBirds = new List<BirdMovement_Old>();
    public static Dictionary<BirdMovement_Old, Vector3> currentBirdsLoc = new Dictionary<BirdMovement_Old, Vector3>();
    public static bool inuse = false;
    public static Dictionary<Vector3Int, HashSet<BirdMovement_Old>> considerationNodes = new Dictionary<Vector3Int, HashSet<BirdMovement_Old>>();
